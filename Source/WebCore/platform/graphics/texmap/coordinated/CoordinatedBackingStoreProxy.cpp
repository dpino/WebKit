...
static constexpr int s_defaultTileDimension = 256;
...
||||||| parent of 8ccaf25aca77 (Allow multiple tile dirty regions. Need the bug URL (OOPS!).)
...
>>>>>>> 8ccaf25aca77 (Allow multiple tile dirty regions. Need the bug URL (OOPS!).)
        tile.markClean();
    }
